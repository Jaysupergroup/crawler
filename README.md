...
Run `npm run test:layout` for the browser-based Pages and Links table regression checks. It builds the client and checks all seven page data tabs and all eight link filters at desktop and mobile widths, plus sorting, search, filtering and inspection. Chromium must be available; the test uses synthetic results and no database.
