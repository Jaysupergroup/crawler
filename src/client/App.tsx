  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <section className="card explorer">
        ...
        {explorerView !== 'history' && explorerView !== 'pages' && <div className="toolbar"><input value={search} onChange={event => setSearch(event.target.value)} placeholder={explorerView === 'links' ? 'Search anchor text, URLs or status codes…' : explorerView === 'resources' ? 'Search resource URLs, types, source pages or status…' : 'Search issue names, URLs, details or severity…'} /></div>}
